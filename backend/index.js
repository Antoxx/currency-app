...
/*
iHelper.setVar('apiUrl', 'http://prerelease.innomdc.com');
iHelper.setVar('groupId', 230);
iHelper.setVar('bucketName', 'bc1');
iHelper.setVar('appName', 'aaa');
iHelper.setVar('appKey', '5L8tri055tav3IWK');
*/
